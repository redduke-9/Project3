...
<h1>  
<%=session.getAttribute("prodName")%></h1>
...
<input id="bidvalue" name="bidvalue" placeholder="Bid Value" style="font-size:20pt;" tabindex="2" type="text" required="required">
 <br></br>
	   <input class="button" name="Submit" id="Submit"  style="font-size:20pt;" value="Bid for the Product" type="Submit" tabindex="3" > 	 
</h2>
</form>
</center> 
</body>
